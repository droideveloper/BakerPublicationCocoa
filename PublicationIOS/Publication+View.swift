...
extension UIView {
	...
	func checkAttrFirst(_ constraint: NSLayoutConstraint, matches: NSLayoutAttribute) -> Bool {
	...
	func checkAttrSecond(_ constraint: NSLayoutConstraint, matches: NSLayoutAttribute) -> Bool {
